...
export function InOrbitIcon({ classname }: InOrbitIconProps) {
  return (
    <svg
      fill="none"
    ...
    >
      ...
      <path
        d="M12 .5a12 12 0 00-2.72.31A12.016 12.016 0 00.31 9.78C.107 10.652 0 11.563 0 12.5c0 6.627 5.373 12 12 12a12 12 0 002.72-.31 12.017 12.017 0 008.97-8.968c.203-.875.31-1.786.31-2.722 0-6.627-5.373-12-12-12zm0 19.515a7.494 7.494 0 01-2.524-.435 7.535 7.535 0 01-4.556-4.555A7.515 7.515 0 1119.515 12.5 7.515 7.515 0 0112 20.015z"
        fill="url(#a)"
      />
      <path
